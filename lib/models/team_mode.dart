...
class TeamModel {
  ...
  TeamModel({this.id, this.name, this.imageUrl});
}
...
List<TeamModel> teamList = [
  TeamModel(
    ...
    name: 'Arsenal',
    imageUrl:
        'https://resources.premierleague.com/premierleague/badges/20/t3.png',
  ),
  TeamModel(
    id: 2,
    name: 'Aston Villa',
    imageUrl:
        'https://resources.premierleague.com/premierleague/badges/20/t7.png',
  ),
  TeamModel(
    id: 3,
    name: 'Bournemouth',
