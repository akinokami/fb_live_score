  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SizedBox(
          ...
          child:cartController.cartList.isNotEmpty?SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Image.network(
                                        ...
                                        int.parse(
                                            element.id.toString()) ==
                                            int.parse(cartController.cartList[index].team
                                                .toString()))
                                            .imageUrl ??
                                            '',
                                        width: 20,
                                      ...
                                      Obx(
                                          ...
                                          onTap: () => cartController
                                              .addToCart(cartController.cartList[index]),
                                          child: Icon(
                                            color: cartController.cartList
                                                .contains(cartController.cartList[index])
                                ...
                                Text(
                                  cartController.cartList[index].secondName ?? "",
                                      ...
                                      SizedBox(
                                        ...
                                        child: Opacity(
                                            ...
                                            child: Text(
                                                ...
                                                Constants().defineType(cartController.cartList[index]
                                                    .elementType ??
                                                    0),
                                                style: smallTextStyleBlack)),
                                      ),
